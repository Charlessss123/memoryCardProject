...
let cardsArray = ['fa-anchor', 'fa-anchor', 'fa-bicycle', 'fa-bolt', 'fa-cube', 'fa-diamond', 'fa-diamond', 'fa-plane', 'fa-leaf', 'fa-bomb', 'fa-leaf', 'fa-bomb', 'fa-bolt', 'fa-bicycle', 'fa-plane', 'fa-cube','fa-briefcase', 'fa-briefcase', 'fa-btc', 'fa-btc', 'fa-building', 'fa-building', 'fa-bullhorn', 'fa-bullhorn', 'fa-bus', 'fa-bus', 'fa-bullseye', 'fa-bullseye', 'fa-calendar', 'fa-calendar', 'fa-calculator', 'fa-calculator','fa-camera', 'fa-camera', 'fa-car', 'fa-car'];
